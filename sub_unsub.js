...
function aa() {
    var date = new Date(2014, 6, 6, 8, 0, 0)
    ...
    var box = random_data.random_app('1');
    var dropbox = random_data.random_app('2');

    var logs = log_format.gen_aie_acvitity_path_log(box, random_data.random_app_activity_path(box, 'login'), _.clone(datas1));

    sendAieActivityPathLog(logs);

    var logs = log_format.gen_aie_acvitity_path_log(dropbox, random_data.random_app_activity_path(dropbox, 'login'), _.clone(datas2));
